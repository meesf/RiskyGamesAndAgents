...
public class ProbabilityGrid {
    ...
    private double diceOdds(int a, int d, int outcome) {
        ...
        throw new RuntimeException(
                "Cannot return a dice probability for attacker throwing with: + " + a + " and defender with: " + d);
    }
    ...
    public double chanceOfWin() {
        return IntStream.rangeClosed(1, attackingUnits).mapToDouble(a -> getValue(a, 0)).sum();
    }
}
